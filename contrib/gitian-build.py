...
def setup():
    ...
    if not os.path.isdir('pivx'):
        subprocess.check_call(['git', 'clone', 'https://github.com/shaanax/pivx.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/shaanax/pivx', help='Specify the URL of the repository. Default is %(default)s')
